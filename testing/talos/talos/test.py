...
@register_test()
class jpeg_scaling_large_1(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 1
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_1.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 4000
    tpmozafterpaint = True
...
@register_test()
class jpeg_scaling_large_1_1(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 1
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_1_1.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 2000
    tpmozafterpaint = True
...
@register_test()
class jpeg_scaling_large_1_2(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 1
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_1_2.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 1300
    tpmozafterpaint = True
...
@register_test()
class jpeg_scaling_large_1_3(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 1
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_1_3.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 800
    tpmozafterpaint = True
...
@register_test()
class jpeg_scaling_large_1_4(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 1
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_1_4.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 550
    tpmozafterpaint = True
...
@register_test()
class jpeg_scaling_large_1_5(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 1
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_1_5.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 250
    tpmozafterpaint = True
...
@register_test()
class jpeg_scaling_large_1_6(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 1
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_1_6.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 250
    tpmozafterpaint = True
...
@register_test()
class jpeg_scaling_large_2(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 2
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_2.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 50
    tpmozafterpaint = True
...
@register_test()
class jpeg_scaling_large_3(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 3
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_3.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 50
    tpmozafterpaint = True
...
@register_test()
class jpeg_scaling_large_4(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 4
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_4.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 50
    tpmozafterpaint = True
...
@register_test()
class jpeg_scaling_large_5(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 5
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_5.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 50
    tpmozafterpaint = True
...
@register_test()
class jpeg_scaling_large_6(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 6
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_6.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 50
    tpmozafterpaint = True
...
@register_test()
class jpeg_scaling_large_7(PageloaderTest):
    """
    Test the scaling of sandbox creation of jpeg 7
    """
    tpmanifest = '${talos}/tests/jpeg_scaling_large/jpeg_scaling_7.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 50
    tpmozafterpaint = True
